...
const HelpModal = ({ setHelpModal }) => {
  return (
    <div>
      <div onClick={() => setHelpModal(false)} className="z-[1200] fixed top-0 left-0 w-full h-full bg-black opacity-60"></div>
      <div className="flex overflow-y-auto justify-center items-center absolute top-0 left-0 w-full h-auto">
        <div className="z-[1300] flex-col justify-center items-center bg-white w-10/12 lg:w-6/12 h-auto rounded-2xl mt-4 lg:mt-autopy-10 px-10" onClick={(e) => { e.stopPropagation() }}>
