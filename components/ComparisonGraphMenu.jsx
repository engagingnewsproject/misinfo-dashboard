...
const ComparisonGraphMenu = ({dateRange, setDateRange, 
  ...
  const handleGraphUpdate = () => {
    ...
    if (updateGraph && selectedTopics.length === 3 && daysSelected > 2 && daysSelected < 31)
      {
      ...
      <div class="flex justify-between items-center">
        ...
        <div class={"flex justify-between items-center"}>
          ...
          {loaded && <button
                ...
                class={updateGraph ? basicStyle : basicStyle + " hidden"}>
                <IoMdRefresh size={25} />
                <ReactTooltip place="top" type="light" effect="solid" delayShow={500} />
          </button>}
          
          {/* Displays loading svg if the graph is being upated. */}
          {!loaded &&         
