...
import { Tooltip, Typography, Switch, Checkbox } from '@material-tailwind/react'
...
const TableBody = ({
	...
	onReportDelete,
	reportsReadState,
	reportsSelectedState,
	onReportSelectedChange,
}) => {
						...
						<tr
							...
							{columns.map(({ accessor }) => {
								...
								if (accessor === 'createdDate') {
									...
									tData = (
										<div
											...
											<Switch
												...
												onChange={(e) =>
													onRowChangeRead(report.reportID, e.target.checked)
												}
												color="blue"
											/>
									...
									tData = (
										<Tooltip
											content={<MemoizedTooltipContent details={details} />}
											placement="bottom-end">
											<Typography>{title}</Typography>
										</Tooltip>
									)
								} else if (accessor === 'checkbox') {
									tData = (
										<Checkbox
											checked={reportsSelectedState[report.reportID] || false}
											color="blue"
											onClick={(e) => {
												e.stopPropagation()
