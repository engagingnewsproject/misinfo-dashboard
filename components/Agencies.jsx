...
const Agencies = ({handleAgencyUpdateSubmit}) => {
	...
	const style = {
		...
		section_title: 'text-xl font-extrabold text-blue-600 dark:text-white-100 tracking-wider',
		...
		table_main: 'min-w-full bg-white dark:bg-slate-600 dark:bg-slate-400 rounded-xl p-1',
		table_thead: 'border-b dark:border-indigo-100 bg-slate-100 dark:bg-slate-500',
		table_th: 'px-3 p-3 text-sm font-semibold text-left tracking-wide',
		table_tr: 'border-b transition duration-300 ease-in-out hover:bg-indigo-100 dark:hover:bg-slate-700 dark:bg-slate-600 hover:dark:bg-indigo-400 dark:border-indigo-100 dark:hover:bg-indigo-100 dark:hover:bg-slate-700 dark:bg-slate-600 hover:dark:bg-indigo-400',
		...
		button: 'flex items-center shadow ml-auto mr-6 bg-white dark:bg-slate-600 hover:bg-gray-100 text-sm py-2 px-4 rounded-lg focus:outline-none focus:shadow-outline'
	}
			...
			<div className={style.section_wrapper}>
				<div className={style.section_header}>
					...
					<div className={style.section_filters}>
						...
						<button className={style.button} onClick={handleAddNewAgencyModal}><FaPlus className="text-blue-600 dark:text-white-100 mr-2" size={12}/>Add Agency</button>
