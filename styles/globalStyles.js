...
const globalStyles = {
  ...
  heading: {
    h1: {
      blue: 'text-2xl font-extrabold text-brand tracking-wider',
  ...
  form: {
    wrap: 'flex flex-col h-auto justify-center items-center bg-white shadow-none rounded-md bg-clip-border min-h-[220px]',
    ...
    input_title:
      'block -mb-3 font-sans text-base antialiased font-semibold leading-relaxed tracking-normal text-brand',
  ...
  input: {
    ...
    label:
      "flex w-full h-full select-none pointer-events-none absolute left-0 font-normal !overflow-visible truncate peer-placeholder-shown:text-blue-gray-500 leading-tight peer-focus:leading-tight peer-disabled:text-transparent peer-disabled:peer-placeholder-shown:text-blue-gray-500 transition-all -top-1.5 peer-placeholder-shown:text-sm text-[11px] peer-focus:text-[11px] before:content[' '] before:block before:box-border before:w-2.5 before:h-1.5 before:mt-[6.4px] before:mr-1 peer-placeholder-shown:before:border-transparent before:rounded-tl-md before:border-t peer-focus:before:border-t-2 before:border-l peer-focus:before:border-l-2 before:pointer-events-none before:transition-all peer-disabled:before:border-transparent after:content[' '] after:block after:flex-grow after:box-border after:w-2.5 after:h-1.5 after:mt-[6.5px] after:ml-1 peer-placeholder-shown:after:border-transparent after:rounded-tr-md after:border-t peer-focus:after:border-t-2 after:border-r peer-focus:after:border-r-2 after:pointer-events-none after:transition-all peer-disabled:after:border-transparent peer-placeholder-shown:leading-[3.75] text-gray-500 peer-focus:text-gray-900 before:border-blue-gray-200 peer-focus:before:!border-gray-900 after:border-blue-gray-200 peer-focus:after:!border-gray-900",
    hint: 'flex items-center gap-1 mt-2 font-sans text-sm antialiased font-normal leading-normal text-gray-700',
    radio:
      'bg-brand hover:bg-blue-500 flex rounded-lg p-2 text-white justify-center checked:bg-blue-500',
    radio_checked:
      'bg-blue-800 flex rounded-lg p-2 text-white justify-center checked:bg-blue-500'
  },
  label: {
    default: 'overflow-hidden inline-block px-5 bg-gray-200 py-1 rounded-md',
    special: 'overflow-hidden inline-block px-5 bg-yellow-400 py-1 rounded-md'
  },
  textarea: {
  ...
  button: {
    sm: 'select-none rounded-lg bg-brand hover:bg-brand-hover py-2 px-4 text-center align-middle font-sans text-xs font-bold uppercase text-white shadow-md shadow-gray-900/10 transition-all hover:shadow-lg hover:shadow-gray-900/20 focus:opacity-[0.85] focus:shadow-none active:opacity-[0.85] active:shadow-none disabled:pointer-events-none disabled:opacity-50 disabled:shadow-none',
    md: 'bg-brand hover:bg-brand-hover',
    md_selected:
      'select-none rounded-lg bg-brand hover:bg-brand-hover py-3 px-6 text-center align-middle font-sans text-xs font-bold uppercase text-white shadow-md shadow-gray-900/10 transition-all hover:shadow-lg hover:shadow-gray-900/20 focus:opacity-[0.85] focus:shadow-none active:opacity-[0.85] active:shadow-none disabled:pointer-events-none disabled:opacity-50 disabled:shadow-none',
    md_block:
  ...
  icon: {
    filled:
      'fill-brand transform -translate-x-1/2 -translate-y-1/2 top-1/2 left-1/2',
    hover: 'hover:fill-brand-hover'
  },
  icon_button: {
    icon: 'fill-brand',
  ...
  page: {
    // py-5 matches adminSectionStyles.section_container (Users, etc.) under Headbar spacer
