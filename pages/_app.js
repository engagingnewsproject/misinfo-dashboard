...
export const metadata = {
	...
	description:
		"Report misinformation in your location for submission to news agencies near that location.",
	generator: "Next.js",
		...
		<ThemeProvider value={style}>
			<AuthContextProvider>
				<Head>
					...
					<meta
						name='twitter:url'
						content='https://misinfo-dashboard.netlify.app'
					/>
					<meta name='twitter:title' content='Misinformation App' />
					<meta
						name='twitter:description'
						content='Report misinformation in your location for submission to news agencies near that location.'
					/>
					<meta
						name='twitter:image'
					...
					<meta
						property='og:image'
						content='https://misinfo-dashboard.netlify.app/icons/apple-touch-icon.png'
					/>
				</Head>
