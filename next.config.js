...
module.exports = withSentryConfig(
  module.exports,
  {
    ...
    // Webpack-only Sentry bundler options (replaces deprecated top-level disableLogger / automaticVercelMonitors)
    ...
    webpack: {
      ...
      // See: https://docs.sentry.io/product/crons/ | https://vercel.com/docs/cron-jobs
